package com.kryvenkosergii.GLTA_BaseCamp2020_REST.engine;
...
import com.kryvenkosergii.GLTA_BaseCamp2020_REST.dto.RestUrl;
import com.kryvenkosergii.GLTA_BaseCamp2020_REST.tools.CommonException;
import com.kryvenkosergii.GLTA_BaseCamp2020_REST.tools.Exception400;
import com.kryvenkosergii.GLTA_BaseCamp2020_REST.tools.Exception404;
...
public abstract class RestCrud {
	...
	protected void throwException(String prefix, String message, int responseCode) {
		...
		switch (responseCode) {
			case 0: throw new CommonException(exceptionMessage);
			case 400: throw new Exception400(exceptionMessage);
			case 404: throw new Exception404(exceptionMessage);
			default: throw new CommonException(exceptionMessage);
		}
	}
